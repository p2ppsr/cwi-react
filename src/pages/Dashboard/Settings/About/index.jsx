...
const About = () => {
  ...
  return (
    <div className={classes.content_wrap}>
      ...
      <Typography paragraph>
        Project Babbage enables you to use new kinds of apps while keeping control over your digital identity. This software is copyright &copy; 2020-2021 Peer-to-peer Privacy Systems Research, LLC. By using this software, or any software that relies upon it it to function, you agree to be bound by the latest version of the{' '}
